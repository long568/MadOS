#ifndef __STM32_USART_THREAD__
#define __STM32_USART_THREAD__
...
#define USART_ID           1
#define USART_APB          2
#define USART_GPIO_ID      A
#define USART_PIN_TX_ID    9
#define USART_PIN_RX_ID    10
#define USART_DMAPO_Tx     1
#define USART_DMAID_Tx     4
#define USART_DMA_Tx_Base  (0x40013800 + 0x04)
...
extern  MadBool  madInitUsart     (void);
extern  int      madUsartPutChar  (int c);
extern  int      madUsartGetChar  (void);
extern  int      madUsartUngetChar(int c);
