 ...
 * uIP
 */
typedef void (*uIP_LinkCallback)(MadVptr p, MadVptr dp);
typedef char (*uIP_AppCallback)(MadVptr p, MadVptr dp);
#if UIP_CORE_APP_DNS
typedef void (*uIP_Dns_Callback)(MadVptr p, char *name, u16_t *ipaddr);
#endif
