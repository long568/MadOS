...
#define ETH_PAYLOAD_LEN      (MAX_ETH_PAYLOAD)
#define ETH_MAX_PACKET_SIZE  (ETH_HEADER + ETH_EXTRA + MAX_ETH_PAYLOAD + ETH_CRC) /*!< ETH_HEADER + ETH_EXTRA + MAX_ETH_PAYLOAD + ETH_CRC */
...
/** 
  ...
  */
#define USE_IP101A
#define PHY_SR                      0                /*!< Tranceiver Status Register */
#define PHY_Speed_Status            ((u16)0x2000)    /*!< Configured information of Speed: 100Mbps */
